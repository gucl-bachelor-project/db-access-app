...
prod-push:
	...
	aws s3 cp docker-compose.yml s3://gkc-bproject-app-docker-composes/db-administration-app/docker-compose.yml
	aws s3 cp docker-compose.prod.yml s3://gkc-bproject-app-docker-composes/db-admin-administration-app/docker-compose.prod.yml
